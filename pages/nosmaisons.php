...
include('../layouts/header.php') ?> <main id="nosMaisons" class="pad-top">
    <article class="container text-center pt-4">
        ...
        <p class="text-justify mt-3"> Que votre choix se porte sur une maison traditionnelle ou sur une maison
            contemporaine, notre йquipe expйrimentйe, composйe de conducteurs de travaux qualifiйs, d’un responsable
            technique
            , d’un responsable qualitй et de technico-commerciaux, est lа pour vous conseiller et vous accompagner
            durant
    ...
    <section class="my-4 container text-center">
        ...
        <div class="d-flex select justify-content-around">
            <select class="custom-select bold mx-3 my-3">
                <option selected class=" bold">STYLE</option>
                <option value="1" class="bold">Contemporain</option>
                <option value="2" class=" bold">Traditionel</option>
            </select>
            <select class="custom-select bold mx-3 my-3">
                <option selected class="bold">TOITURE</option>
                <option value="1" class="bold">Ardoise</option>
                <option value="2" class="bold">Moderne</option>
                <option value="3" class="bold">Tuiles</option>
            </select>
            <select class="custom-select bold mx-3 my-3">
                <option selected class="bold">NIVEAU</option>
        ...
        <option value="3" class="custom-select bold">Tuiles</option> -->
            ...
            <select class="custom-select bold mr-3 my-3">
                <option selected class=" bold">NB CHAMBRE(S)</option>
                <option value="1" class=" bold">2</option>
                <option value="2" class=" bold">3</option>
                <option value="3" class=" bold">4</option>
                <option value="4" class=" bold">5</option>
            </select>
        </div>
            ...
            <div class="card">
                <a href="1.php" class="text-left">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text description">Maison traditionnelle à étage de 104 m² habitables environ.
                            Belle pièce de
                            vie de 40m², 3 chambres dont une salle de bains,mezzanine, bureau, cellier, salle de bains
                            et WC séparés.
                        </p>
                    </div>
                </a>
            ...
            <div class="card">
                <a href="2.php" class="text-left">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text description">Maison contemporaine à étage de 106m² environ. Au RDC, belle
                            pièce de vie
            ...
            <div class="card">
                <a href="3.php" class="text-left">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-title mb-0">109m²</p>
                        <p class="card-text description">Maison traditionnelle de plain-pied de109m² environ. Grande
                            pièce de vie de
                            53m², 3 chambres, cellier, salle de bains et WC. Cette maison bénéficie également d'un grand
                            garage. </p>
                    </div>
                </a>
            </div>
